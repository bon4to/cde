...
FORMATTERS = {
    ...
    'ImageFormatter': ('pygments.formatters.img', 'img', ('img', 'IMG', 'img'), ('*.img',), 'Create a PNG image from source code. This uses the Python Imaging Library to generate a pixmap from the source code.'),
